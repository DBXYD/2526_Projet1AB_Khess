...
* Conventisseur 230V à 12V DC
    * 1 Porte-fusible
    * 1 Convertisseur PSK-15E-12
    * 1 Condensateur 100uF
    * 1 Condensateur 1uF
    * 1 Diode TVS (824 500 500)
    * 1 Résistance bobinée 6,8 Ohm (remplacée par un fil)
    * 1 Varistance TVS 10D561K (non mise)

* Commande du tiroir caisse
    * 1 Diode DST10100S
    * 1 Transistor BUK9637-100E,118
